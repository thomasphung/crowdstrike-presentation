...
- July 19th, 2024 04:09 UTC - Configuration file update first distributed
...
::: {.notes}
Unfortunately this is not the year of the Linux desktop. There was a Linux kernel bug that caused an issue with CrowdStrike's products.
:::
